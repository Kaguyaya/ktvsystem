...
import com.kaguya.ktvadmin.config.MinIoProperties;
import io.minio.*;
...
public class MinIoUtil {
    ...
    @SneakyThrows(Exception.class)
    public static List<String> getFileName(Bucket bucket) throws XmlParserException, ServerException, InvalidBucketNameException, InsufficientDataException, ErrorResponseException, IOException, NoSuchAlgorithmException, InvalidKeyException, InvalidResponseException, InternalException {
        ...
        for (Result<Item> result:myObjects
                ...
                item.userMetadata();
            arrayList.add(java.net.URLDecoder.decode(item.objectName(),"utf-8"));
        }
        return arrayList;
    }
